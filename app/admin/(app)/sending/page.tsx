...
export default function SendingPage() {
  ...
  if (realRole !== "owner") {
    return (
      <div>
        <PageHeader title="Sending" subtitle="Every automatic message the shop sends, and the switches." />
          ...
          <div>
            ...
            <div className="mt-0.5 text-xs text-white/65">
              {masterOn
                ...
                : "The queues below still fill safely, but nothing goes out on its own until texting approval is finished and sending is switched on. Manual sends from the Follow-ups page still work."}
            </div>
          </div>
        </div>
      </Card>
