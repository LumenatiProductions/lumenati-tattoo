...
import { Card, SectionTitle, StatCard, StatRow, Badge } from "@/components/admin/ui";
...
export default function RentPage() {
  ...
  return (
    <div>
      <TabHeader title="Booth Rent" subtitle="Who's paid, who's behind." />
      ...
      <StatRow>
        ...
        <StatCard label="Paid this month" value={fmt(collectedCents)} tone="good" sub="this month's invoices only" />
