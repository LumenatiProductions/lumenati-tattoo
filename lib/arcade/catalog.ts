...
export const GAME_CATALOG = [
  ...
  { id: "steady", label: "Steady Hand", exe: "steadyhand.exe", hint: "Up/Down steers // hold SPACE to ink // pack the shading", statB: "Trust", cap: 1000000, fmt: "plain", blurb: "Trace the stencil clean. Flinches happen. Trust runs out when you wander." },
