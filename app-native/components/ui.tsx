...
const styles = StyleSheet.create({
  ...
  btn: { backgroundColor: theme.brand, borderRadius: theme.radius.md, paddingVertical: 15, paddingHorizontal: 18, alignItems: "center" },
  ...
  btnDanger: { backgroundColor: theme.badSoft, borderColor: "rgba(251,113,133,0.4)", borderWidth: 1, borderRadius: theme.radius.md, paddingVertical: 14, paddingHorizontal: 18, alignItems: "center" },
