...
values
  ...
  ('elaine', 'fine line // florals // electric energy',
   'Electric Elaine. delicate fine-line and florals with a little electricity in them. small pieces, big pieces, first tattoos welcome. DM me on IG to book or swing by the shop and say hi.',
  ...
  ('shorty', 'bold // traditional // loud',
   'ShorTy. bold traditional, the kind that still reads from across the room in twenty years. flash always on the wall, walk-ins always welcome. DM to book or just show up.',
   'shorty.tattoo', 'shorty', '#7FFF00', '/legacy-assets/sqsp-031.png',
   '[]'::jsonb, '[]'::jsonb),
  ('kalypso', 'color // realism // royalty',
   'King Kalypso. color realism -- portraits, animals, anything that needs to look alive on skin. bring your reference and let''s build it. DM to book a consult.',
  ...
  ('moonie', 'dark // surreal // dreamy',
   'Moonie B. Jones, guest spot. dark, surreal, dreamy pieces -- if it feels like a fever dream, that''s the point. limited dates while I''m in town, DM to grab one.',
